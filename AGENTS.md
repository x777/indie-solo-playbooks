...
- `en/playbooks/01`–`14` — English mirrors. If the user writes in English, read these first.
...
- `README.md` / `en/README.md` — human catalogs.
...
5. Reply in the user's language. Match playbook language to the reply language.
...
| X / one-product feed | `skills/indie-launch-x` | 02, 04 |
| TikTok / Reels / UGC / warmup | `skills/indie-launch-shortform` | 01, 09, 11 |
