<p align="center">
  <img src="../assets/cover-en.svg" alt="Indie Solo Playbooks" width="100%" />
</p>
...
| 05 | [Danny Postma](playbooks/05-danny-postma.md) | [@dannypostma](https://x.com/dannypostma) | Commercial search + a product that shows itself |
...
| 08 | [Rob Hallam](playbooks/08-rob-hallam.md) | [@robj3d3](https://x.com/robj3d3) | Demand first, then code. Validate before building |
...
| [indie-launch-seo](../skills/indie-launch-seo/SKILL.md) | search, domains, commercial pages, AEO |
...
Or open the repo as a project — `AGENTS.md` already points at the skills. Adapters: [`CLAUDE.md`](../CLAUDE.md), [`.github/copilot-instructions.md`](../.github/copilot-instructions.md).
...
Do not read all 14. Pick one system for your channel and run 30 days only on that. For an agent: load a skill first, then one playbook. Every file header switches RU ↔ EN.
...
[MIT](../LICENSE). How to add a playbook: [`CONTRIBUTING.md`](../CONTRIBUTING.md).

---

<p align="center">
  <sub>Living archive · updated 11 September 2026 · <a href="playbooks/01-jack-friks.md">playbooks</a> · <a href="../skills/">skills</a> · <a href="../README.md">RU</a></sub>
</p>
